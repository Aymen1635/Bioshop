                    ...
                    child: Padding(
                      ...
                      child: Column(
                        children: <Widget>[
                          ...
                          FadeAnimation(1.5, Container(margin: EdgeInsets.only(top: 50),
                              child: TextButton(child: Text("Im User", style: TextStyle(color: Colors.white,fontSize: 20),),onPressed:()=> Navigator.of(context).push(MaterialPageRoute(builder: (context) => LoginScreen())))),
                          )],
                      ),
                    ),
                  )
