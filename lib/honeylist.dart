...
class HoneyList extends StatefulWidget {
  HoneyList(this.test);
  final bool test;

  @override
  _HoneyListState createState() => _HoneyListState(test);
}

class _HoneyListState extends State<HoneyList> {
...
final bool test;
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder(
        stream: FirebaseFirestore.instance.collection("Honey").snapshots(),
                          ...
                          children: <Widget>[
                            ...
                            Visibility(
                              ...
                              child: FloatingActionButton(
                                ...
                                onPressed: () {
                                  Navigator.of(context).pushReplacement(MaterialPageRoute(builder: (context)=>((MyEditPage(plantName,imgPath,price,id,"Honey")))));
  ...
  void DeleteDoc(String id) {
    final collection = FirebaseFirestore.instance.collection('Honey');
    collection
