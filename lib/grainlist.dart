...
class GrainList extends StatefulWidget {
  ...
  @override
  _GrainListState createState() => _GrainListState(test);
}
...
class _GrainListState extends State<GrainList> {
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder(
        stream: FirebaseFirestore.instance.collection("Grains").snapshots(),
                            ...
                            Visibility(
                              ...
                              child: FloatingActionButton(
                                ...
                                onPressed: () {
                                  ...
                                  Navigator.of(context).pushReplacement(MaterialPageRoute(builder: (context)=>((MyEditPage(plantName,imgPath,price,id,"Grains")))));
                                },
  ...
  void DeleteDoc(String id) {
    final collection = FirebaseFirestore.instance.collection('Grains');
    collection
