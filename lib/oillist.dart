...
class OilList extends StatefulWidget {
  ...
  @override
  _OilListState createState() => _OilListState(test);
}

class _OilListState extends State<OilList> {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder(
        stream: FirebaseFirestore.instance.collection("Oils").snapshots(),
                  ...
                  children: <Widget>[
                    Row(
                      ...
                      children: <Widget>[
                        ...
                        Container(margin: EdgeInsets.only(left: 55),
                          child: Column(
                          ...
                          children: <Widget>[
                            ...
                            Visibility(
                              ...
                              child: FloatingActionButton(
                                ...
                                onPressed: () {
                                  Navigator.of(context).pushReplacement(MaterialPageRoute(builder: (context)=>((MyEditPage(plantName,imgPath,price,id,"Oils")))));
                                },
  ...
  void DeleteDoc(String id) {
    final collection = FirebaseFirestore.instance.collection('Oils');
    collection
